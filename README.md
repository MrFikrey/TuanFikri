...
def loginSC():
	...
	if username =="Tuan" and password =="Fikrey":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Animalstv')
				menu()
